...
export function SurveyBuilderProvider({ surveyId, children }: { surveyId: string; children: React.ReactNode }) {
  ...
  const addQuestion = (type: QuestionType) => {
    const newQuestion: Question = {
      ...
      prompt: "",
      is_required: false,
      options: type === "multiple_choice" ? [{ id: crypto.randomUUID(), value: "Option 1" }] : undefined,
    };
